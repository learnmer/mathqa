...
function calculateNodeHeight(sizingData, value, minRows, maxRows, addheight) {
  if (minRows === void 0) {
    minRows = 1;
  }
  if (maxRows === void 0) {
...
var _excluded = ["cacheMeasurements", "maxRows", "minRows", "addheight", "onChange", "onHeightChange"];
